  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: Text(widget.data['title'] != null
              ? widget.data['title']
              : 'no have title'),
        ),
        body: Card(
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          TextButton.icon(
                            onPressed: () {},
                            icon:
                                Icon(Icons.person, color: HexColor('#1dbf73')),
                            label: Text(
                                widget.data['personName'] != null
                      ...
                      Row(
                        children: [
                          ...
                          Spacer(),
                          Text(widget.data['publishData'] != null
                              ? widget.data['publishData']
                              : 'No have publishData'),
                        ],
                      ),
                      Divider(),
                      Row(
                        children: [
                          TextButton.icon(
                            onPressed: () {},
                            icon: Icon(Icons.money, color: HexColor('#1dbf73')),
                            label: Text(
                              "الميزانية",
                              style: TextStyle(color: Colors.blueGrey[400]),
                            ),
                      ...
                      Row(
                        children: [
                          ...
                          Spacer(),
                          Text(widget.data['durationproject'] != null
                              ? widget.data['durationproject']
                              : 'No have durationproject'),
                        ],
                      ),
                      Divider(),
                      Row(
                      ...
                      Row(
                        children: [
                          ...
                          Spacer(),
                          Expanded(
                              child: Text(widget.data['Averageproject'] != null
                                  ? widget.data['Averageproject']
                                  : 'No have Averageproject')),
                        ],
                      ),
                    ],
                  ),
